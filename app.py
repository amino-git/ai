...
<h3>📌 ملاحظة هامة بخصوص تدريب المشروع أونلاين</h3>
<p>
أثناء تدريب النموذج على Streamlit Cloud، البيانات تُحفظ مؤقتًا، وعند تحديث الصفحة أو إعادة تشغيل التطبيق، يتم فقدان كل التدريب.<br>
لقد حاولنا ربط التخزين مع Google Drive لحفظ النموذج والبيانات بشكل دائم، وتم تفعيل Google Cloud، لكن التخزين المشترك يحتاج إلى Google Workspace المدفوع.<br>
كما حاولنا استخدام AWS S3، لكن مشكلة اختيار اسم Bucket فريد عالميًا جعلت الحل صعب التطبيق.<br>
لذلك، Colab أو GitHub غير مناسبين للتدريب المباشر وحفظ البيانات بشكل دائم.<br>
نوصي بمناقشة حلول بديلة لحفظ بيانات النموذج أثناء التدريب أونلاين بشكل دائم وآمن.
</p>
